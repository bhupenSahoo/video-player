...
const Video = () => {
  ...
  const [videSrc, setVideSrc] = useState(videosArr[0]);
    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        >
          ...
          <Text>
            This is a sample video. Loree sequi! Molestiae mollitia dolorem
            lorem200 ipsam amet. lorem200
          </Text>
        </VStack>
      </VStack>
